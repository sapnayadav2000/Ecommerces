...
(function ($) {
    ...
    /*Sale */
    $('.ec-trend-product .ec-trend-sale').slick({
        rows: 2,
        dots: false,
        arrows: false,
        infinite: true,
...
/*Saree */
$('.ec-trend-product .ec-trend-saree').slick({
    rows: 2,
    dots: false,
    arrows: false,
    infinite: true,
...
/*Lehenga */
$('.ec-trend-product .ec-trend-lehenga').slick({
    rows: 2,
    dots: false,
    arrows: false,
    infinite: true,
...
/*Dresses */
$('.ec-trend-product .ec-trend-dresses').slick({
    rows: 2,
    dots: false,
    arrows: false,
    infinite: true,
